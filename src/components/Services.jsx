      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="  relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-40 xl:h-[46rem]">
            <div className="absolute top-0 left-0 h-full w-full pointer-events-none md:3/5 xl:h[46rem]">
              <img
            ...
            <Generating className=" absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 lg:w-[50rem]" />
          </div>
                    ...
                    {brainwaveServicesIcons.map((item, index) => (
                      <li
                        className={`rounded-2xl flex items-center justify-center  ${
                          index === 2
                            ? "w-[3rem] h-[3rem] p-1 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem] "
